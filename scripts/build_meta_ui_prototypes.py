...
""",
    ...
    "meta-dark-sidebar-glass": Variant(
        ...
        sidebar_end="#ffffff",
        sidebar_text="#172033",
        sidebar_muted="#344054",
        primary="#0866ff",
        primary_2="#1877f2",
        shadow_1="0 2px 8px rgba(15,23,42,.07)",
...
body[data-variant="meta-dark-sidebar-glass"] .sidebar {
  background:
    radial-gradient(ellipse 820px 390px at 0 0, rgba(255,218,202,.60) 0%, rgba(255,238,231,.28) 42%, rgba(255,255,255,0) 78%),
    #fff;
...
body[data-variant="meta-dark-sidebar-glass"] .brand-copy span,
body[data-variant="meta-dark-sidebar-glass"] .sidebar-account-copy span {
  color: #667085;
}
...
body[data-variant="meta-dark-sidebar-glass"] .sidebar-section {
  color: #98a2b3;
  font-weight: 600;
}
body[data-variant="meta-dark-sidebar-glass"] .nav-link {
  color: #344054;
  font-size: 14px;
  font-weight: 600;
}
body[data-variant="meta-dark-sidebar-glass"] .nav-link svg {
  color: #667085;
}
...
body[data-variant="meta-dark-sidebar-glass"] .metric:last-child {
  border-right: 0;
}
body[data-variant="meta-dark-sidebar-glass"] .metric > div {
  display: contents;
}
body[data-variant="meta-dark-sidebar-glass"] .metric::after {
  content: "";
  position: absolute;
  bottom: 0;
  left: 50%;
...
body[data-variant="meta-dark-sidebar-glass"] .metric-icon {
  grid-area: icon;
  width: 15px;
  height: 15px;
  border: 0;
...
body[data-variant="meta-dark-sidebar-glass"] .metric-icon svg {
  width: 14px;
  height: 14px;
  stroke-width: 1.8;
}
body[data-variant="meta-dark-sidebar-glass"] .metric-label {
  grid-area: label;
  color: #344054;
  font-size: 12px;
  font-weight: 600;
}
body[data-variant="meta-dark-sidebar-glass"] .metric-value {
  grid-area: value;
  margin-top: 6px;
  color: var(--metric-accent);
  font-size: 30px;
}
body[data-variant="meta-dark-sidebar-glass"] .metric-meta {
  grid-area: meta;
  margin-top: 7px;
  color: #667085;
  font-size: 10.5px;
...
body[data-variant="meta-dark-sidebar-glass"] .card-head {
  position: relative;
  min-height: 66px;
  gap: 10px;
  padding: 14px 16px;
}
body[data-variant="meta-dark-sidebar-glass"] .card-head::before {
  content: none;
}
body[data-variant="meta-dark-sidebar-glass"] .card-accounts { --section-accent: #0866ff; }
body[data-variant="meta-dark-sidebar-glass"] .card-campaigns { --section-accent: #4f46e5; }
body[data-variant="meta-dark-sidebar-glass"] .card-resources { --section-accent: #0f8f6f; }
body[data-variant="meta-dark-sidebar-glass"] .section-icon {
  width: 22px;
  height: 22px;
  border: 0;
  border-radius: 0;
...
body[data-variant="meta-dark-sidebar-glass"] .section-icon svg {
  width: 18px;
  height: 18px;
}
body[data-variant="meta-dark-sidebar-glass"] .section-copy h2,
body[data-variant="meta-dark-sidebar-glass"] .item-title {
  color: #101828;
}
body[data-variant="meta-dark-sidebar-glass"] .section-copy h2 {
  font-size: 15px;
}
body[data-variant="meta-dark-sidebar-glass"] .section-copy p {
  display: none;
}
body[data-variant="meta-dark-sidebar-glass"] .toolbar,
body[data-variant="meta-dark-sidebar-glass"] th {
  background: #f7f9fc;
}
body[data-variant="meta-dark-sidebar-glass"] .toolbar {
  min-height: 52px;
...
body[data-variant="meta-dark-sidebar-glass"] .toolbar-label {
  font-size: 11px;
}
body[data-variant="meta-dark-sidebar-glass"] .chip {
  height: 32px;
  font-size: 11px;
}
body[data-variant="meta-dark-sidebar-glass"] th {
...
body[data-variant="meta-dark-sidebar-glass"] td {
  color: #344054;
  padding: 14px 16px;
}
body[data-variant="meta-dark-sidebar-glass"] table {
  font-size: 12.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .item-title {
  font-size: 12.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .item-meta {
  margin-top: 4px;
  font-size: 10.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .status {
  padding: 5px 8px;
  font-size: 10.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .progress-step {
  font-size: 9.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .row-button {
  width: 32px;
  height: 32px;
}
body[data-variant="meta-dark-sidebar-glass"] .button {
  font-size: 12px;
}
body[data-variant="meta-dark-sidebar-glass"] .chip.active {
  border-color: #a5b4fc;
  background: #eef2ff;
  color: #4338ca;
}
body[data-variant="meta-dark-sidebar-glass"] .card-campaigns .progress-step.active {
  color: #4f46e5;
}
body[data-variant="meta-dark-sidebar-glass"] .card-campaigns .progress-step.active::before {
  border-color: #4f46e5;
  box-shadow: 0 0 0 3px rgba(79,70,229,.14);
}
body[data-variant="meta-dark-sidebar-glass"] .status-draft {
  border: 1px solid #d8d5ff;
  background: #eeedff;
  color: #4338ca;
}
body[data-variant="meta-dark-sidebar-glass"] .status-pending {
  border: 1px solid #f2d7a8;
  background: #fff3dc;
  color: #8a4b08;
}
body[data-variant="meta-dark-sidebar-glass"] .status-approved,
body[data-variant="meta-dark-sidebar-glass"] .status-online {
  border: 1px solid #b9dfd2;
  background: #e2f5ee;
  color: #0f6b50;
}
body[data-variant="meta-dark-sidebar-glass"] .card-resources .empty-icon {
  border-color: #b9dfd2;
  background: #eaf8f3;
  color: #0f8f6f;
}
body[data-variant="meta-dark-sidebar-glass"] .empty-state h3 {
  font-size: 14px;
}
body[data-variant="meta-dark-sidebar-glass"] .empty-state p {
  font-size: 11.5px;
}
body[data-variant="meta-dark-sidebar-glass"] .topbar {
  background:
    radial-gradient(ellipse 820px 390px at -248px 0, rgba(255,218,202,.60) 0%, rgba(255,238,231,.28) 42%, rgba(255,255,255,0) 78%),
    #fff;
  border-bottom-color: #cbd5e1;
  box-shadow: 0 2px 6px rgba(15,23,42,.05);
}
body[data-variant="meta-dark-sidebar-glass"] .page-identity h1 {
  font-size: 20px;
}
body[data-variant="meta-dark-sidebar-glass"] .breadcrumb {
  font-size: 12px;
}
body[data-variant="meta-dark-sidebar-glass"] .global-search input {
  font-size: 13px;
}
...
@media (max-width: 720px) {
  ...
  body[data-variant="meta-dark-sidebar-glass"] .metric:nth-child(2) {
    border-right: 0;
  }
  body[data-variant="meta-dark-sidebar-glass"] .metric:nth-child(-n+2) {
...
@media (max-width: 1120px) and (min-width: 721px) {
  body[data-variant="meta-dark-sidebar-glass"] .topbar {
    background:
      radial-gradient(ellipse 820px 390px at -82px 0, rgba(255,218,202,.60) 0%, rgba(255,238,231,.28) 42%, rgba(255,255,255,0) 78%),
      #fff;
  }
}
""",
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .sidebar-account-button {
      width: 100%; min-height: 50px; display: flex; align-items: center; gap: 10px; padding: 7px 9px;
      border: 0; border-radius: 9px; background: transparent; color: inherit; text-align: left; cursor: pointer;
      transition: background-color 150ms ease;
    }
    .sidebar-account-button:hover { background: rgba(255,255,255,.09); }
    .sidebar-account-button > svg { width: 14px; height: 14px; margin-left: auto; color: var(--sidebar-muted); }
    .sidebar-account-copy { min-width: 0; line-height: 1.25; }
    .sidebar-account-copy strong { display: block; font-family: var(--font-display); font-size: 12px; }
    .sidebar-account-copy span { display: block; margin-top: 2px; color: var(--sidebar-muted); font-size: 9px; }
    ...
    .icon-button:hover { border-color: color-mix(in srgb, var(--primary) 45%, var(--border)); background: var(--surface-soft); }
    ...
    .sidebar-account-popover { top: auto; right: 12px; bottom: calc(100% + 8px); left: 12px; width: auto; min-width: 220px; }
    ...
    .button:focus-visible, .icon-button:focus-visible, .sidebar-account-button:focus-visible, .chip:focus-visible, .prototype-switcher button:focus-visible { outline: 3px solid color-mix(in srgb, var(--primary) 24%, transparent); outline-offset: 2px; }
    ...
    dialog { width: min(660px, calc(100vw - 32px)); max-height: min(820px, calc(100vh - 36px)); padding: 0; overflow: hidden; border: 1px solid #cbd5e1; border-radius: 12px; background: #fff; color: #172033; box-shadow: 0 18px 50px rgba(15,23,42,.22); }
    ...
    .dialog-head { position: relative; min-height: 74px; display: flex; align-items: center; gap: 0; padding: 17px 20px; border-bottom: 1px solid #e1e6ee; }
    .dialog-title h2 { margin: 0; font-family: var(--font-display); font-size: 18px; line-height: 1.25; letter-spacing: -.015em; }
    .dialog-title p { margin: 4px 0 0; color: #667085; font-size: 12px; line-height: 1.45; }
    .dialog-close { margin-left: auto; width: 32px; height: 32px; display: grid; place-items: center; border: 0; border-radius: 8px; background: #f3f5f8; color: #667085; cursor: pointer; }
    .dialog-close:hover { background: #e8ecf2; color: #172033; }
    .dialog-close:focus-visible { outline: 3px solid rgba(6,104,225,.2); outline-offset: 2px; }
    .dialog-close svg { width: 17px; height: 17px; }
    .dialog-body { max-height: calc(100vh - 210px); overflow: auto; padding: 20px; scrollbar-width: thin; scrollbar-color: #98a2b3 transparent; scrollbar-gutter: stable; }
    .dialog-body::-webkit-scrollbar, .custom-select-menu::-webkit-scrollbar { width: 10px; }
    .dialog-body::-webkit-scrollbar-track, .custom-select-menu::-webkit-scrollbar-track { margin-block: 9px; background: transparent; }
    .dialog-body::-webkit-scrollbar-thumb, .custom-select-menu::-webkit-scrollbar-thumb { border: 3px solid #fff; border-radius: 999px; background: #98a2b3; }
    .dialog-body::-webkit-scrollbar-corner, .custom-select-menu::-webkit-scrollbar-corner { background: transparent; }
    .dialog-fields { display: grid; gap: 18px; }
    .dialog-fields .field { margin-bottom: 0; }
    dialog .field label { margin-bottom: 8px; font-size: 12px; }
    dialog .field input, dialog .field select, dialog .field textarea { border-color: #b9c5d6; background: #fff; }
    dialog .field input, dialog .field select { height: 44px; }
    dialog .field-help { margin-top: 7px; font-size: 10.5px; line-height: 1.45; }
    .required-mark { margin-left: 2px; color: #b83a3a; }
    .dialog-inline-meta { margin-top: -5px; color: #667085; font-size: 10.5px; line-height: 1.5; }
    .custom-select { position: relative; }
    .custom-select-trigger { width: 100%; height: 44px; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 0 12px; border: 1px solid #b9c5d6; border-radius: 9px; background: #fff; color: #172033; font: inherit; text-align: left; cursor: pointer; }
    ...
    .dialog-foot { min-height: 64px; display: flex; align-items: center; justify-content: flex-end; gap: 8px; padding: 12px 20px; border-top: 1px solid #e1e6ee; background: #fff; }
    ...
    @media (max-width: 1120px) {
      ...
      .brand-copy, .nav-label, .sidebar-section, .sidebar-account-copy, .sidebar-account-button > svg { display: none; }
      ...
      .sidebar-account-button { width: 50px; justify-content: center; padding-inline: 0; }
      .sidebar-account-popover { top: auto; left: calc(100% + 8px); right: auto; bottom: 12px; width: 230px; }
...
<body data-variant="__SLUG__">
      ...
      <div class="shell">
        <aside class="sidebar" aria-label="Điều hướng chính">
          ...
          <footer class="sidebar-footer popover-wrap">
            ...
            <div class="popover sidebar-account-popover hidden" data-popover="admin">
        ...
        <main class="app-main">
          ...
          <div class="content-pane">
            <div class="content">
              ...
              <section class="card card-accounts">
                <div class="card-head">
              ...
              <section class="card card-campaigns">
                <div class="card-head">
  ...
  <dialog id="campaign-dialog">
    <form data-prototype-form="campaign">
      <header class="dialog-head"><div class="dialog-title"><h2>Tạo campaign draft</h2><p>Chỉ lưu bản nháp trong Ads Meta Master.</p></div><button class="dialog-close" type="button" data-dialog-close aria-label="Đóng"><i data-lucide="x"></i></button></header>
      <div class="dialog-body">
        <div class="dialog-fields"><div class="field"><label for="campaign-account">Ad account<span class="required-mark" aria-hidden="true">*</span></label><div class="custom-select" data-custom-select><button class="custom-select-trigger" id="campaign-account" type="button" popovertarget="campaign-account-menu" aria-haspopup="listbox" aria-expanded="false" data-custom-select-trigger><span data-custom-select-label>Lush Ads Main · USD</span><i data-lucide="chevron-down"></i></button><input type="hidden" name="campaign_account" value="lush-main" data-custom-select-value><div class="custom-select-menu" id="campaign-account-menu" popover="auto" role="listbox" aria-labelledby="campaign-account" data-custom-select-menu><button class="custom-select-option" type="button" role="option" aria-selected="true" data-value="lush-main">Lush Ads Main · USD</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="campaign-lab">Campaign Lab · VND</button></div></div><div class="field-help">Resource và asset sẽ được lọc theo ad account này.</div></div><div class="field"><label for="campaign-name">Tên campaign<span class="required-mark" aria-hidden="true">*</span></label><input id="campaign-name" value="Awareness — August Launch" required></div><div class="field-row"><div class="field"><label for="campaign-objective">Objective<span class="required-mark" aria-hidden="true">*</span></label><div class="custom-select" data-custom-select><button class="custom-select-trigger" id="campaign-objective" type="button" popovertarget="campaign-objective-menu" aria-haspopup="listbox" aria-expanded="false" data-custom-select-trigger><span data-custom-select-label>Awareness</span><i data-lucide="chevron-down"></i></button><input type="hidden" name="campaign_objective" value="Awareness" data-custom-select-value><div class="custom-select-menu" id="campaign-objective-menu" popover="auto" role="listbox" aria-labelledby="campaign-objective" data-custom-select-menu><button class="custom-select-option" type="button" role="option" aria-selected="true" data-value="Awareness">Awareness</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="Traffic">Traffic</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="Engagement">Engagement</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="Leads">Leads</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="App promotion">App promotion</button><button class="custom-select-option" type="button" role="option" aria-selected="false" data-value="Sales">Sales</button></div></div></div><div class="field"><label for="campaign-budget">Ngân sách mỗi ngày (USD)<span class="required-mark" aria-hidden="true">*</span></label><input id="campaign-budget" inputmode="decimal" value="50.00" required></div></div><div class="dialog-inline-meta">Bản nháp sẽ dừng ở Review để bạn kiểm tra trước khi tiếp tục.</div><div class="field"><label for="campaign-note">Ghi chú (không bắt buộc)</label><textarea id="campaign-note" placeholder="Ví dụ: Kiểm tra nội dung và ngân sách trước khi tiếp tục."></textarea></div></div>
      </div>
      <footer class="dialog-foot"><button class="button" type="button" data-dialog-close>Hủy</button><button class="button primary-button" type="submit">Tạo bản nháp</button></footer>
    </form>
  </dialog>

  <dialog class="small-dialog" id="password-dialog">
    <form data-prototype-form="password">
      <header class="dialog-head"><div class="dialog-title"><h2>Đổi mật khẩu</h2><p>Các phiên khác sẽ được đăng xuất sau khi cập nhật.</p></div><button class="dialog-close" type="button" data-dialog-close aria-label="Đóng"><i data-lucide="x"></i></button></header>
      ...
      <footer class="dialog-foot"><button class="button" type="button" data-dialog-close>Hủy</button><button class="button primary-button" type="submit">Cập nhật mật khẩu</button></footer>
    </form>
  </dialog>

  <dialog class="small-dialog" id="danger-dialog">
    <form data-prototype-form="danger">
      <header class="dialog-head"><div class="dialog-title"><h2>Xóa bản nháp?</h2><p>Bạn không thể khôi phục thao tác này.</p></div><button class="dialog-close" type="button" data-dialog-close aria-label="Đóng"><i data-lucide="x"></i></button></header>
      ...
      <footer class="dialog-foot"><button class="button" type="button" data-dialog-close>Giữ bản nháp</button><button class="button danger-button" type="submit">Xóa bản nháp</button></footer>
    </form>
  </dialog>
  ...
  <script>
    (function () {
      ...
      document.querySelectorAll('[data-custom-select]').forEach(function (root) {
        ...
        const value = root.querySelector('[data-custom-select-value]');
        ...
        menu.addEventListener('toggle', function (event) {
          ...
          const selected = options.find(function (option) { return option.getAttribute('aria-selected') === 'true'; }) || options[0];
          if (selected) selected.focus();
        });

        options.forEach(function (option, index) {
          option.addEventListener('click', function () {
            options.forEach(function (candidate) { candidate.setAttribute('aria-selected', String(candidate === option)); });
            label.textContent = option.textContent.trim();
            value.value = option.getAttribute('data-value') || option.textContent.trim();
            menu.hidePopover();
            trigger.focus();
          });
        ...
        window.addEventListener('resize', function () {
          if (menu.matches(':popover-open')) positionCustomSelect(trigger, menu);
        });
      });
      ...
      document.querySelectorAll('[data-dialog-open]').forEach(function (button) {
        button.addEventListener('click', function () {
          ...
          if (dialog && !dialog.open) {
            dialog.showModal();
            const preferredFocus = dialog.querySelector('[data-custom-select-trigger], input:not([readonly]), select:not([disabled]), textarea:not([readonly])')
              || dialog.querySelector('.dialog-foot [data-dialog-close]');
