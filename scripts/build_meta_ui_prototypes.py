...
body[data-variant="meta-dark-sidebar-glass"] .brand {
  background: linear-gradient(110deg, #e6f0ff 0%, #f0ebff 54%, #ffe9f3 100%);
}
...
body[data-variant="meta-dark-sidebar-glass"] .brand > .brand-mark {
  box-shadow: 0 0 0 3px rgba(255,255,255,.86), 0 2px 6px rgba(30,64,175,.18);
}
...
body[data-variant="meta-dark-sidebar-glass"] .active-nav {
  ...
  background: #f7f9fc;
  color: #295b9c;
  box-shadow: 0 3px 10px rgba(15,23,42,.09), inset 0 1px 0 rgba(255,255,255,.92);
}
...
body[data-variant="meta-dark-sidebar-glass"] .sidebar-footer .avatar {
  background: linear-gradient(135deg, #0866ff 0%, #7c3aed 56%, #ec4899 100%);
  color: #fff;
...
body[data-variant="meta-dark-sidebar-glass"] .section-icon {
  ...
  background: color-mix(in srgb, var(--section-accent) 13%, #fff);
