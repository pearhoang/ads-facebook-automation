...
- Canvas giữ base neutral gần trắng; một ellipse glow warm-peach rất nhạt có chung tâm tại góc viewport trên trái, nối liên tục qua sidebar và topbar rồi tan trước vùng content/KPI. Glow không nằm sau table/card. Panel dùng border và shadow nông; header bỏ accent line. Section helper copy ngắn vẫn hiển thị dưới tiêu đề để giải thích scope, còn icon chỉ dùng một tile nhỏ theo semantic accent ở đầu section. Table/KPI tăng cỡ chữ metadata, row height và spacing thay vì thêm panel trang trí.
