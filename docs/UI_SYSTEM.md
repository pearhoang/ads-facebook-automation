...
- `Meta Light Focus` tách vai trò màu để tăng scanability: logo/CTA/ad-account dùng Meta blue `#0866FF`; selected navigation dùng gradient pastel xanh–lavender với chữ/icon indigo, campaign draft dùng indigo; pending dùng amber; approved/resource dùng green. Inactive sidebar text dùng slate `#344054`; selected row chỉ có border và shadow nhẹ để không cạnh tranh với CTA.
