...
- `Meta Light Focus` tách vai trò màu để tăng scanability: logo/CTA/ad-account dùng Meta blue `#0866FF`; selected navigation dùng surface gần trắng `#F7F9FC`, chữ/icon xanh slate và elevation nông; campaign draft dùng indigo; pending dùng amber; approved/resource dùng green. Inactive sidebar text dùng slate `#344054`; selected row không dùng gradient để không cạnh tranh với brand band, avatar hoặc CTA.
